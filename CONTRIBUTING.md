# Contributing to aiglossary.news

The following is a set of guidelines for contributing to this repository and the glossary of AI terms at [aiglossary.news](https://aiglossary.news/).
...
The definitions published by the site are stored in the [`dictionary`](https://github.com/ryan-serpico/aiglossary.news/blob/main/_data/dictionary) folder in the `_data` directory.
